...
class LdapObjectCollectionSpec extends ObjectBehavior
{
    ...
    public function it_should_implement_an_interator()
    {
    ...
    public function it_should_expect_any_number_of_objects_to_the_constructor()
    {
        $this->beConstructedWith(...$this->ldapObjects);
        $this->count()->shouldBeEqualTo(4);
    }

    public function it_should_add_objects_to_the_collection()
    {
        $this->add(new LdapObject(['foo' => 'bar']));
    }

    public function it_should_return_a_count_of_the_objects_it_contains()
    {
    ...
    public function it_should_return_an_array_of_objects_when_calling_to_array()
    {
        $this->add(new LdapObject(['foo' => 'bar']));
    ...
    public function it_should_get_the_last_item_of_the_collection()
    {
        $this->add(...$this->ldapObjects);
        $this->last()->getFirstName()->shouldBeEqualTo('Chad');
    }

    public function it_should_get_the_first_item_of_the_collection()
    {
        $this->add(...$this->ldapObjects);
        $this->last()->getFirstName()->shouldBeEqualTo('Chad');
    ...
    public function it_should_advance_to_the_next_item_when_calling_next()
    {
        $this->add(...$this->ldapObjects);
        $this->next()->getFirstName()->shouldBeEqualTo('Scott');
    }

    public function it_should_go_back_to_the_previous_item_when_calling_previous()
    {
        $this->add(...$this->ldapObjects);
        $this->next()->getFirstName()->shouldBeEqualTo('Scott');
    ...
    public function it_should_get_the_current_object_when_calling_current()
    {
        $this->add(...$this->ldapObjects);
        $this->last();
        $this->previous();
    ...
    public function it_should_get_the_current_index_when_calling_key()
    {
        $this->add(...$this->ldapObjects);
