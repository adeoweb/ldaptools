...
class BatchSpec extends ObjectBehavior
{
    ...
    public function it_should_have_the_attribute_set_correctly()
    {
        $this->getAttribute()->shouldBeEqualTo('foo');
    }

    public function it_should_have_the_values_set_correctly()
    {
        $this->getValues()->shouldBeEqualTo(['bar']);
    }

    public function it_should_have_the_correct_mod_type_set()
    {
        $this->getModType()->shouldBeEqualTo(LDAP_MODIFY_BATCH_REPLACE);
    }

    public function it_should_set_the_value_correctly()
    {
    ...
    public function it_should_convert_a_remove_all_batch_to_its_correct_array_form()
    {
        $this->setModType(LDAP_MODIFY_BATCH_REMOVE_ALL);
        $this->toArray()->shouldBeEqualTo([
            'attrib' => 'foo',
    ...
    public function it_should_error_when_trying_to_use_an_invalid_batch_mod_type()
    {
    ...
    public function it_should_be_able_to_check_what_mod_type_it_is()
    {
    ...
    public function it_should_let_a_value_be_determined_by_a_closure()
    {
        $foo = function () {
            return 'foo';
        };
