...
class ConvertGroupMembershipSpec extends ObjectBehavior
{
    ...
    public function it_should_implement_operation_generator_interface()
    {
        $this->shouldImplement('\LdapTools\AttributeConverter\OperationGeneratorInterface');
    }
    
    public function it_should_act_as_a_multivalued_converter()
    {
    ...
    public function it_should_only_specify_the_original_attribute_to_be_removed_on_modification_or_creation()
    {
        $this->setOperationType(AttributeConverterInterface::TYPE_CREATE);
    ...
    public function it_should_convert_a_LdapObject_back_to_a_dn()
    {
        $this->setOperationType(AttributeConverterInterface::TYPE_SEARCH_TO);
    ...
    public function it_should_error_if_a_LdapObject_is_missing_a_DN()
    {
        $this->setOperationType(AttributeConverterInterface::TYPE_SEARCH_TO);
    ...
    public function it_should_generate_add_operations_based_off_a_name_guid_sid_and_LdapObject_on_a_create_operation($connection, AddOperation $operation)
    {
        $sid = 'S-1-5-21-1004336348-1177238915-682003330-512';
        $sidHex = '\01\05\00\00\00\00\00\05\15\00\00\00\dc\f4\dc\3b\83\3d\2b\46\82\8b\a6\28\00\02\00\00';
        $guid = 'a1131cd3-902b-44c6-b49a-1f6a567cda25';
     ...
     */
    public function it_should_generate_add_and_remove_operations_on_a_modify_operation($connection, BatchModifyOperation $operation)
    {
        $sid = 'S-1-5-21-1004336348-1177238915-682003330-512';
        $sidHex = '\01\05\00\00\00\00\00\05\15\00\00\00\dc\f4\dc\3b\83\3d\2b\46\82\8b\a6\28\00\02\00\00';
        $guid = 'a1131cd3-902b-44c6-b49a-1f6a567cda25';
    ...
    public function it_should_generate_operations_to_remove_all_current_groups_on_a_modify_reset_operation($connection, LdapOperationInterface $operation)
    {
    ...
    public function it_should_generate_operations_to_remove_all_current_groups_and_add_new_ones_on_a_modify_set_operation($connection, LdapOperationInterface $operation)
    {
