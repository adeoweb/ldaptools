...
class ConvertGPLinkSpec extends ObjectBehavior
{
    ...
    public function it_should_convert_a_gPLink_string_to_an_array_of_GPOLink_objects()
    {
    ...
    public function it_should_convert_an_empty_or_unparsable_gPLink_string_to_an_empty_array()
    {
        $this->fromLdap([''])->shouldBeEqualTo([]);
    }

    public function it_should_convert_an_array_of_GPOLinks_to_a_bracket_encased_dn_string_form_for_ldap()
    {
    ...
    public function it_should_aggregate_values_when_converting_an_array_of_GPOLinks_to_ldap_on_modification($connection)
    {
    ...
    public function it_should_return_a_single_space_if_all_GPO_links_are_removed_on_modification()
    {
        $this->setOperationType(AttributeConverterInterface::TYPE_MODIFY);
    ...
    public function it_should_early_return_an_empty_string_on_a_reset_and_not_modify_the_batch_type()
    {
        $this->setOperationType(AttributeConverterInterface::TYPE_MODIFY);
