...
class ConvertBooleanSpec extends ObjectBehavior
{
    ...
    public function it_should_return_a_php_bool_from_a_ldap_bool()
    {
    ...
    public function it_should_return_a_php_true_bool_from_a_ldap_true_bool()
    {
        $this->fromLdap('TRUE')->shouldBeEqualTo(true);
    }

    public function it_should_return_a_php_false_bool_from_a_ldap_false_bool()
    {
        $this->fromLdap('FALSE')->shouldBeEqualTo(false);
    }

    public function it_should_return_a_ldap_false_bool_from_a_php_false_bool()
    {
        $this->toLdap(false)->shouldBeEqualTo('FALSE');
    }

    public function it_should_return_a_ldap_true_bool_from_a_php_true_bool()
    {
