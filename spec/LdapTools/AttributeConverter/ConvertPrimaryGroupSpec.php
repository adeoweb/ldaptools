...
class ConvertPrimaryGroupSpec extends ObjectBehavior
{
    ...
    public function let(\LdapTools\Connection\LdapConnectionInterface $connection)
    {
    ...
    public function it_should_return_a_group_name_from_ldap()
    {
        $this->fromLdap('513')->shouldBeEqualTo('Domain Users');
    }

    public function it_should_return_the_RID_to_LDAP_when_given_the_group_name_on_modification()
    {
        $this->setOperationType(AttributeConverterInterface::TYPE_MODIFY);
        $this->toLdap('Domain Users')->shouldBeEqualTo('513');
    }

    public function it_should_throw_an_error_when_the_user_is_not_a_member_of_the_group_or_the_group_cannot_be_found_on_modification()
    {
        $this->setOperationType(AttributeConverterInterface::TYPE_MODIFY);
        $this->setDn('foo');
    ...
    public function it_should_not_validate_group_membership_when_going_to_ldap_if_the_op_type_is_not_modification($connection)
    {
