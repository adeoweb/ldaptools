...
class ConvertADTimeSpanSpec extends ObjectBehavior
{
    ...
    public function it_should_convert_an_ADTimeSpec_to_a_string_for_LDAP()
    {
        $adTimeSpan = (new ADTimeSpan())->setDays(10);
        $this->toLdap($adTimeSpan)->shouldBeEqualTo('-8640000000000');
    }

    public function it_should_allow_a_ADTimeSpan_going_to_LDAP_set_to_a_Never_value()
    {
        $adTimeSpan = (new ADTimeSpan())->setNever(true);
        $this->toLdap($adTimeSpan)->shouldBeEqualTo(ADTimeSpan::NEVER);
    }

    public function it_should_error_when_not_an_instace_of_ADTimeSpan_going_to_ldap()
    {
    ...
    public function it_should_convert_a_ldap_time_span_value_into_an_ADTimeSpan_object()
    {
