...
class ConvertLogonWorkstationsSpec extends ObjectBehavior
{
    ...
    public function it_should_convert_a_string_of_comma_separated_workstations_to_an_array()
    {
        $this->fromLdap(['foo,bar'])->shouldBeEqualTo(['foo','bar']);
        $this->fromLdap(['foo'])->shouldBeEqualTo(['foo']);
    }

    public function it_should_convert_an_array_of_workstations_to_a_comma_separated_list_for_ldap()
    {
        $this->setOperationType(AttributeConverterInterface::TYPE_CREATE);
        $this->toLdap(['foo','bar'])->shouldBeEqualTo('foo,bar');
    }

    public function it_should_implode_the_values_immediately_for_a_search()
    {
    ...
    public function it_should_not_attempt_to_modify_values_on_a_reset()
    {
        $this->setOperationType(AttributeConverterInterface::TYPE_MODIFY);
