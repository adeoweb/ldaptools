...
class ConvertWindowsSecuritySpec extends ObjectBehavior
{
    ...
    public function it_should_accept_a_SDDL_string_or_SecurityDescriptor_going_to_ldap()
    {
    ...
    public function it_should_return_a_security_descriptor_from_ldap()
    {
        $sddl = 'O:PSG:PSD:(A;CI;RCCC;;;PS)';
        $sd = (new SddlParser())->parse($sddl);
    ...
    public function it_should_throw_an_exception_if_a_invalid_value_is_passed_going_to_ldap()
    {
