...
class ConvertEnumSpec extends ObjectBehavior
{
    ...
    public function it_should_convert_an_enum_to_ldap()
    {
        $this->setOperationType(ConvertEnum::TYPE_CREATE);
        $this->toLdap('DistributionGroup')->shouldBeEqualTo('1');
    }

    public function it_should_convert_an_enum_object_instance_to_ldap()
    {
        $this->setOperationType(ConvertEnum::TYPE_CREATE);
    ...
    public function it_should_convert_an_enum_from_ldap()
    {
        $this->setOperationType(ConvertEnum::TYPE_SEARCH_FROM);
        $this->fromLdap('1')->shouldBeEqualTo('DistributionGroup');
    }

    public function it_should_throw_an_error_if_the_enum_does_not_implement_the_enum_interface()
    {
