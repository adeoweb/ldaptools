...
class ConvertAccountExpirationSpec extends ObjectBehavior
{
    ...
    public function it_should_convert_a_never_expiring_account_to_a_bool_from_ldap()
    {
        $this->fromLdap('0')->shouldBeEqualTo(false);
        $this->fromLdap('9223372036854775807')->shouldBeEqualTo(false);
    }

    public function it_should_convert_an_account_with_an_expiration_date_to_a_datetime_object()
    {
