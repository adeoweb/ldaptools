...
class OperatorValueResolverSpec extends ObjectBehavior
{
    ...
    public function it_should_convert_attributes_and_values()
    {
    ...
    public function it_should_convert_attributes_and_values_when_the_operators_contain_other_operators()
    {
    ...
    public function it_should_convert_values_for_multiple_aliases()
    {
    ...
    public function it_should_convert_the_filter_for_a_schema_if_it_uses_mapped_attribute_names_with_converters()
    {
    ...
    public function it_should_convert_values_with_operators_to_filters()
    {
    ...
    public function it_should_properly_convert_values_when_using_a_multivalued_converter()
    {
