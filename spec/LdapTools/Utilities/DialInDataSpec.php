...
class DialInDataSpec extends ObjectBehavior
{
    ...
    public function it_should_be_able_to_be_constructed_from_a_binary_string()
    {
        $this->beConstructedWith(hex2bin($this->testData));
        $this->getUserPrivilege()->shouldEqual(9);
    }
    
    public function it_should_have_a_default_UserPrivilege_of_1_when_newly_constructed()
    {
        $this->getUserPrivilege()->shouldEqual(1);
    }
    
    public function it_should_convert_back_to_binary()
    {
        $this->beConstructedWith(hex2bin($this->testData));
        $this->toBinary()->shouldEqual(hex2bin($this->testData));
    }
    
    public function it_should_set_an_empty_callback_phone_number_if_it_is_not_supplied()
    {
    ...
    public function it_should_set_the_user_privilege_and_callback_number_when_converting_back_to_binary()
    {
    ...
    public function it_should_get_the_signature()
    {
        $this->beConstructedWith(hex2bin($this->testData));
    ...
    public function it_should_check_if_the_signature_is_valid()
    {
