...
class MBStringSpec extends ObjectBehavior
{
    ...
    public function it_should_get_a_specific_character_given_a_code_point()
    {
        $this::chr(65)->shouldEqual('A');
        $this->chr(225)->shouldEqual('á');
    }
    
    public function it_should_get_a_code_point_for_a_given_character()
    {
        $this::ord('A')->shouldEqual(65);
        $this::ord('á')->shouldEqual(225);
    }
    
    public function it_should_split_a_string_and_return_an_array_of_chars()
    {
        $this::str_split('foo')->shouldEqual(['f', 'o', 'o']);
        $this::str_split('bár')->shouldEqual(['b', 'á', 'r']);
    }
    
    public function it_should_compare_two_strings_and_return_an_integer_value()
    {
    ...
    public function it_should_make_a_string_lower_case()
    {
        $this::strtolower('Ädam')->shouldEqual('ädam');
        $this::strtolower('FOO')->shouldEqual('foo');
    }

    public function it_should_change_the_case_of_the_values_for_an_array()
    {
