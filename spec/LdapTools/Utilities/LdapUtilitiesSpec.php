...
class LdapUtilitiesSpec extends ObjectBehavior
{
    ...
    public function it_should_unescape_hex_values_back_to_a_string()
    {
        $this::unescapeValue('\46\6f\6f\3d\42\61\72')->shouldBeEqualTo('Foo=Bar');
    }

    public function it_should_explode_a_dn_to_an_array()
    {
    ...
    public function when_exploding_a_dn_it_should_unescape_hex_values()
    {
    ...
    public function it_should_check_if_an_attribute_is_a_valid_OID_or_short_name()
    {
    ...
    public function it_should_check_if_a_value_is_a_valid_SID()
    {
        $SIDs = [
    ...
    public function it_should_check_if_a_value_is_a_valid_GUID()
    {
    ...
    public function it_should_explode_a_legacy_dn()
    {
    ...
    public function it_should_get_the_rdn_from_a_dn()
    {
        $this::getRdnFromDn('cn=Foo,dc=example,dc=com')->shouldBeEqualTo('cn=Foo');
    }
    
    public function it_should_get_the_parent_of_a_dn()
    {
        $this::getParentDn('cn=Foo,dc=example,dc=com')->shouldBeEqualTo('dc=example,dc=com');
    }
    
    public function it_should_throw_an_error_when_there_is_no_parent_dn()
    {
        $this->shouldThrow('\LdapTools\Exception\InvalidArgumentException')->during('getParentDn', ['o=foo']);
    }
    
    public function it_should_mask_passwords_and_binary_in_an_array_of_attributes_and_values()
    {
        $attributes = [
            'username' => 'foo',
    ...
    public function it_should_mask_passwords_and_binary_data_in_a_ldap_batch_array()
    {
        $batch = [
            [
                "attrib"  => "unicodePwd",
    ...
    public function it_should_check_if_a_string_is_actually_binary_data()
    {
    ...
    public function it_should_split_a_string_between_its_alias_and_attribute()
    {
        $this::getAliasAndAttribute('foo.bar')->shouldBeEqualTo(['foo', 'bar']);
        $this::getAliasAndAttribute('foobar')->shouldBeEqualTo([null, 'foobar']);
    }

    public function it_should_generate_a_UUIDv4_string()
    {
