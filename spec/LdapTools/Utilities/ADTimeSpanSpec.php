...
class ADTimeSpanSpec extends ObjectBehavior
{
    ...
    public function it_should_be_initializable_with_a_time_from_ldap()
    {
    ...
    public function it_should_initialize_properly_with_a_Never_value_from_LDAP()
    {
    ...
    public function it_should_initialize_properly_with_a_Zero_value_from_LDAP()
    {
    ...
    public function it_should_have_a_string_representation_for_Never()
    {
        $this->setNever(true);
        $this->__toString()->shouldBeEqualTo('Never');
    }

    public function it_should_get_a_value_formatted_for_LDAP()
    {
        $this->setDays(5);
        $this->setHours(7);
        $this->setMinutes(8);
    ...
    public function it_should_allow_a_time_span_of_never_to_be_set()
    {
        $this->setNever(true);
