...
class LdapObjectHydratorSpec extends ObjectBehavior
{
    ...
    public function it_should_extend_the_array_hydrator()
    {
        $this->shouldHaveType('\LdapTools\Hydrator\LdapObjectHydrator');
    }

    public function it_should_error_if_attempting_to_hydrate_a_non_LdapObject_to_ldap()
    {
        $this->shouldThrow('\InvalidArgumentException')->duringHydrateToLdap([]);
    }

    public function it_should_hydrate_an_entry_from_ldap_to_a_ldap_object()
    {
        $this->hydrateFromLdap($this->ldapEntries[0])->shouldReturnAnInstanceOf('\LdapTools\Object\LdapObject');
    }

    public function it_should_hydrate_all_entries_from_ldap_to_a_ldap_object_collection()
    {
    ...
    public function it_should_hydrate_a_ldap_object_with_batch_modification()
    {
    ...
    public function it_should_hydrate_a_ldap_object_wihtout_a_schema_with_batch_modification()
    {
