...
class ArrayHydratorSpec extends ObjectBehavior
{
    ...
    public function it_should_implement_the_HydratorInterface()
    {
        $this->shouldImplement('\LdapTools\Hydrator\HydratorInterface');
    }

    public function it_should_be_able_to_be_constructed_with_a_ldap_connection(LdapConnectionInterface $connection)
    {
        $this->beConstructedWith($connection);
        $this->shouldHaveType('LdapTools\Hydrator\ArrayHydrator');
    }

    public function it_should_set_selected_attributes_when_calling_setSelectedAttributes()
    {
        $attributes = ['foo', 'bar'];
    ...
    public function it_should_set_LdapObjectSchemas_when_calling_setLdapObjectSchema()
    {
    ...
    public function it_should_return_a_single_array_with_keys_when_calling_hydrateEntryFromLdap()
    {
        $this->setSelectedAttributes(['sn']);
        $this->hydrateFromLdap($this->ldapEntries[0])->shouldHaveKey('sn');
    }

    public function it_should_return_the_correct_number_of_entries_when_hydrating_all_entries()
    {
        $this->hydrateAllFromLdap($this->ldapEntries)->shouldHaveCount(2);
    }

    public function it_should_allow_multiple_schema_names_pointing_to_the_same_ldap_attribute()
    {
    ...
    public function it_should_not_change_attribute_names_when_the_attribute_was_selected_by_its_original_name()
    {
        $schema = new LdapObjectSchema('ad', 'user');
    ...
    public function it_should_respect_the_case_the_attribute_was_selected_by_when_hydrating()
    {
        $schema = new LdapObjectSchema('ad', 'user');
        $schema->setAttributeMap(['firstName' => 'givenName', 'lastName' => 'sn']);
        $this->setLdapObjectSchema($schema);
    ...
    public function it_should_convert_values_if_a_converter_was_defined_for_an_attribute()
    {
        $schema = new LdapObjectSchema('ad', 'user');
    ...
    public function it_should_allow_multiple_converter_types_for_one_ldap_attribute()
    {
        $schema = new LdapObjectSchema('ad', 'user');
        $schema->setAttributeMap(['firstName' => 'givenName', 'lastName' => 'sn', 'created' => 'whenCreated', 'createdInt' => 'whenCreated']);
    ...
    public function it_should_return_the_dn_attribute_even_if_it_wasnt_selected()
    {
        $schema = new LdapObjectSchema('ad', 'user');
        $schema->setAttributeMap(['firstName' => 'givenName', 'lastName' => 'sn']);
        $this->setLdapObjectSchema($schema);
    ...
    public function it_should_return_an_array_when_hydrating_to_ldap()
    {
        $schema = new LdapObjectSchema('ad', 'user');
    ...
    public function it_should_hydrate_to_ldap_even_without_a_schema()
    {
        $this->hydrateToLdap($this->objectToLdap)->shouldBeArray();
    }

    public function it_should_error_when_a_required_attribute_is_missing_going_to_ldap()
    {
        $schema = new LdapObjectSchema('ad', 'user');
    ...
    public function it_should_error_hydrating_to_ldap_if_an_array_is_not_used()
    {
        $this->shouldThrow('LdapTools\Exception\InvalidArgumentException')->duringHydrateToLdap(new LdapObject(['foo' => 'bar']));
    }

    public function it_should_merge_default_attributes_to_ldap()
    {
        $schema = new LdapObjectSchema('ad', 'user');
    ...
    public function it_should_rename_schema_names_to_ldap_attributeNames_when_hyrdating_to_ldap()
    {
        $schema = new LdapObjectSchema('ad', 'user');
    ...
    public function it_should_replace_parameter_values_with_their_actual_values()
    {
        $schema = new LdapObjectSchema('ad', 'user');
        $schema->setAttributeMap([
            'firstName' => 'givenName',
    ...
    public function it_should_convert_values_when_hydrating_to_ldap()
    {
        $schema = new LdapObjectSchema('ad', 'user');
