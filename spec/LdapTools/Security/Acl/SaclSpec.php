...
class SaclSpec extends ObjectBehavior
{
    ...
    public function it_should_parse_and_get_the_ACL_revision()
    {
        $this->getRevision()->shouldBeEqualTo(4);
    }

    public function it_should_parse_and_get_the_sbz1_value()
    {
        $this->getSbz1()->shouldBeEqualTo(0);
    }

    public function it_should_set_the_sbz1_value()
    {
        $this->setSbz1(1)->getSbz1()->shouldBeEqualTo(1);
    }

    public function it_should_parse_and_get_the_sbz2_value()
    {
        $this->getSbz2()->shouldBeEqualTo(0);
    }

    public function it_should_set_the_sbz2_value()
    {
        $this->setSbz2(1)->getSbz2()->shouldBeEqualTo(1);
    }

    public function it_should_parse_and_get_the_ACEs_for_the_ACL()
    {
    ...
    public function it_should_set_the_ACL_revision()
    {
        $this->setRevision(Acl::REVISION['GENERIC'])->getRevision()->shouldBeEqualTo(Acl::REVISION['GENERIC']);
    }

    public function it_should_get_the_sddl_representation_when_calling_toSddl()
    {
        $this->toSddl()->shouldBeEqualTo($this->expecteSddl);
    }

    public function it_should_have_a_string_representation_that_outputs_the_sddl()
    {
