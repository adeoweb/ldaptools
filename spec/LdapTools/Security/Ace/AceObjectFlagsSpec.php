...
class AceObjectFlagsSpec extends ObjectBehavior
{
    ...
    public function it_should_check_the_flags()
    {
    ...
    public function it_should_check_or_set_whether_the_object_type_is_present()
    {
        $this->objectTypePresent()->shouldBeEqualTo(true);
        $this->objectTypePresent(false)->objectTypePresent()->shouldBeEqualTo(false);
    }

    public function it_should_check_or_set_whether_the_inherited_object_type_is_present()
    {
    ...
    public function it_should_check_whether_both_object_type_are_invalid()
    {
