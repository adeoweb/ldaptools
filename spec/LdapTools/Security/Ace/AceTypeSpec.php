...
class AceTypeSpec extends ObjectBehavior
{
    ...
    public function it_should_get_the_type_value()
    {
        $this->getValue()->shouldBeEqualTo(0);
    }

    public function it_should_set_the_type()
    {
        $this->setValue(AceType::TYPE['ACCESS_DENIED'])->getValue()->shouldBeEqualTo(AceType::TYPE['ACCESS_DENIED']);
    }

    public function it_should_get_the_short_name_for_the_type()
    {
        $this->getShortName()->shouldBeEqualTo('A');
    }

    public function it_should_have_a_string_representation_of_the_SDDL_short_name()
    {
        $this->__toString()->shouldBeEqualTo('A');
    }

    public function it_should_allow_being_constructed_by_the_SDDL_short_name()
    {
    ...
    public function it_should_allow_being_constructed_by_the_constant_name()
    {
    ...
    public function it_should_throw_an_InvalidArgumentExcecption_when_being_constructed_with_an_invalid_type()
    {
        $this->shouldThrow('LdapTools\Exception\InvalidArgumentException')->during('__construct', ['foo']);
    }

    public function it_should_throw_an_InvalidArgumentExcecption_when_setting_an_invalid_type()
    {
