...
class OperatorCollectionSpec extends ObjectBehavior
{
    ...
    public function it_should_add_a_ldapobjectschema_when_calling_addLdapObjectSchema()
    {
    ...
    public function it_should_add_a_ldapobjectschema_with_a_specific_alias()
    {
        $schema = new LdapObjectSchema('foo', 'bar');
        $alias = 'foobar';
    ...
    public function it_should_validate_an_alias_name()
    {
        $schema = new LdapObjectSchema('foo', 'bar');
    ...
    public function it_should_add_a_ldapobjectschema_with_an_alias_of_the_object_type_by_default()
    {
        $this->addLdapObjectSchema(new LdapObjectSchema('foo', 'bar'));
        $this->getAliases()->shouldHaveKey('bar');
    }

    public function it_should_sort_the_operators()
    {
        $this->add(new MatchingRule('foo', MatchingRuleOid::BitOr, 1));
        $this->add(new bAnd());
    ...
    public function it_should_get_the_ldap_filter_for_the_operators()
    {
        $this->add(new Comparison('foo', Comparison::EQ, 'bar'));
    ...
    public function it_should_get_the_ldap_filter_for_all_aliases_and_wrap_them_in_an_or_statement()
    {
        $foo = new LdapObjectSchema('foo', 'foo');
    ...
    public function it_should_get_the_ldap_filter_for_a_specific_alias()
    {
        $foo = new LdapObjectSchema('foo', 'foo');
        $foo->setFilter(new Comparison('foo', Comparison::EQ, 'bar'));
        $bar = new LdapObjectSchema('foo', 'bar');
    ...
    public function it_should_throw_an_exception_when_trying_to_get_a_filter_for_an_alias_that_doesnt_exist()
    {
        $this->shouldThrow('LdapTools\Exception\InvalidArgumentException')->duringToLdapFilter('foo');
    }

    public function it_should_clone_the_operator_objects_when_cloning_the_collection()
    {
    ...
    public function it_should_chain_add_calls()
    {
        $this->add(new bAnd())->shouldReturnAnInstanceOf('LdapTools\Query\OperatorCollection');
    }

    public function it_should_only_wrap_the_filter_in_an_and_when_the_collection_has_more_than_one_object()
    {
