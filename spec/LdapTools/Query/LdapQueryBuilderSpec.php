...
class LdapQueryBuilderSpec extends ObjectBehavior
{
    ...
    public function it_should_return_the_selected_attributes_when_calling_getAttributes()
    {
    ...
    public function it_should_return_self_when_calling_setScopeBase()
    {
        $this->setScopeBase()->shouldReturnAnInstanceOf('\LdapTools\Query\LdapQueryBuilder');
    }

    public function it_should_return_self_when_calling_setScopeOneLevel()
    {
        $this->setScopeOneLevel()->shouldReturnAnInstanceOf('\LdapTools\Query\LdapQueryBuilder');
    }

    public function it_should_return_self_when_calling_setScopeSubTree()
    {
        $this->setScopeSubTree()->shouldReturnAnInstanceOf('\LdapTools\Query\LdapQueryBuilder');
    }

    public function it_should_return_self_when_setting_the_paging_size_and_use()
    {
    ...
    public function it_should_set_the_scope_types_correctly()
    {
    ...
    public function it_should_set_subtree_as_the_default_scope()
    {
        $this->getScope()->shouldBeEqualTo(QueryOperation::SCOPE['SUBTREE']);
    }

    public function it_should_return_ADFilterBuilder_when_calling_filter_and_the_ldap_type_is_ActiveDirectory()
    {
        $this->filter()->shouldBeLike(new ADFilterBuilder());
    }

    public function it_should_return_FilterBuilder_when_calling_filter_and_the_ldap_type_is_not_ActiveDirectory()
    {
        $domain = new DomainConfiguration('example.com');
        $domain->setServers(['example'])
            ->setBaseDn('dc=example,dc=com')
    ...
    public function it_should_return_the_filter_when_calling_toLdapFilter()
    {
    ...
    public function it_should_not_escape_hex_string_search_values_that_are_already_escaped()
    {
    ...
    public function it_should_throw_a_LogicException_when_calling_getLdapQuery_and_a_ldap_connection_is_not_set()
    {
    ...
    public function it_should_throw_a_LogicException_when_calling_from_with_a_string_and_a_schema_factory_is_not_set()
    {
        $this->beConstructedWith(null, null);
        $this->shouldThrow('LdapTools\Exception\LogicException')->during('from', ['foo']);
    }

    public function it_should_set_the_attributes_to_select()
    {
    ...
    public function it_should_add_additional_statements_to_the_AND_section_of_the_filter_when_calling_andWhere()
    {
        $this->where(['foo' => 'bar']);
    ...
    public function it_should_add_an_order_by_attribute_defaulting_to_asc()
    {
        $this->where(['foo' => 'bar'])->orderBy('foo')->getLdapQuery()->getOrderBy()->shouldBeEqualTo(['foo' => 'ASC']);
    }

    public function it_should_add_an_order_by_attribute_defaulting_with_a_specific_direction()
    {
        $this->where(['foo' => 'bar'])->orderBy('foo', 'DESC')->getLdapQuery()->getOrderBy()->shouldBeEqualTo(['foo' => 'DESC']);
    }

    public function it_should_stack_order_by_attributes_when_calling_addOrderBy()
    {
        $this->where(['foo' => 'bar'])->orderBy('foo', 'DESC')->addOrderBy('bar')->getLdapQuery()->getOrderBy()->shouldBeEqualTo(['foo' => 'DESC','bar' => 'ASC']);
    }

    public function it_should_overwrite_order_by_attributes_when_calling_orderBy()
    {
        $this->where(['foo' => 'bar'])->orderBy('foo', 'DESC')->orderBy('bar')->getLdapQuery()->getOrderBy()->shouldBeEqualTo(['bar' => 'ASC']);
    }
    
    public function it_should_add_LDAP_controls_to_the_query_operation()
    {
    ...
    public function it_should_filter_by_OUs_when_calling_fromOUs()
    {
    ...
    public function it_should_pass_operation_options_on_to_the_LdapQuery_class_correctly()
    {
    ...
    public function it_should_allow_use_paging_to_be_set_per_query()
    {
    ...
    public function it_should_allow_the_ldap_server_to_be_set_per_query()
    {
    ...
    public function it_should_set_the_ldap_server()
    {
    ...
    public function it_should_hydrate_properly_getting_the_ldap_filter($connection)
    {
    ...
    public function it_should_get_a_filter_without_a_schema_or_connection()
    {
    ...
    public function it_should_generate_a_filter_from_multiple_types()
    {
        $this->fromUsers();
        $this->fromGroups();
    ...
    public function it_should_generate_a_filter_from_multiple_types_when_using_an_alias()
    {
        $this->fromUsers('u');
        $this->fromGroups('g');
    ...
    public function it_should_be_able_to_call_from_with_a_dynamic_schema_type_name()
    {
