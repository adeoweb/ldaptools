...
class FilterBuilderSpec extends ObjectBehavior
{
    ...
    public function it_should_get_an_instance_through_the_factory_method(LdapConnectionInterface $connection)
    {
    ...
    public function it_should_correctly_format_a_match_dn_filter()
    {
        $this->matchDn('ou', 'Sales')->toLdapFilter()->shouldBeEqualTo('(ou:dn:=Sales)');
    }

    public function it_should_correctly_format_an_in_filter()
    {
